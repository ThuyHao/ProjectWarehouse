                    ...
                    <div class="masonry-box post-media">
                        ...
                        <div class="shadoweffect">
                            <div class="shadow-desc">
                                <div class="blog-meta">
                                    <span class="bg-orange"><a href="" title="">${homeWithMaxId.nameCategory}</a></span>
                                    <h4><a href="<c:url value="/detail?id=${homeWithMaxId.id}"/>" title="">${homeWithMaxId.title}</a></h4>
                                    <small><a href="tech-single.html" title="">${homeWithMaxId.dayUp}</a></small>
                                    <small><a href="tech-author.html" title="">${homeWithMaxId.nameAuthor}</a></small>
                                </div><!-- end meta -->
                            </div><!-- end shadow-desc -->
                        </div><!-- end shadow -->
                    </div><!-- end post-media -->
                        ...
                        <div class="blog-list clearfix">
                            ...
                            <div class="blog-box row">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="tech-single.html" title="">
                                            <img src="<c:url value="${homeAggregateList.image}"/>" alt="" class="img-fluid">
                                ...
                                <div class="blog-meta big-meta col-md-8">
                                    <h4><a href="<c:url value="/detail?id=${homeAggregateList.id}"/>" title="">${homeAggregateList.title}</a></h4>
                                    <p>${homeAggregateList.description}</p>
                                    <small class="firstsmall"><a class="bg-orange" href="tech-category-01.html" title="">${homeAggregateList.nameCategory}</a></small>
                                    <small><a href="tech-single.html" title="">${homeAggregateList.dayUp} </a></small>
                                    <small><a href="tech-author.html" title="">${homeAggregateList.nameAuthor}</a></small>
                                </div><!-- end meta -->
                            </div><!-- end blog-box -->
                            <hr class="invis">
                            </c:forEach>
                                ...
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="banner-spot clearfix">
                                        <div class="banner-img">
                                            <c:url var="imageUrl" value="https://ecdn.game4v.com/g4v-content/uploads/2022/04/15152216/3-buoc-don-gian-nhan-trang-phuc-an-chinh-voi-gia-re-nhu-cho-7-1650010936-96.jpg" />
...
<%--                            <c:forEach var="stagingList" items="${stagingList}">--%>
<%--                                <div class="blog-box row">--%>
<%--                                    <div class="col-md-4">--%>
<%--                                        <div class="post-media">--%>
<%--                                            <a href="tech-single.html" title="">--%>
<%--                                                <img src="<c:url value="${stagingList.image}"/>" alt="" class="img-fluid">--%>
<%--                                                <div class="hovereffect"></div>--%>
<%--                                            </a>--%>
<%--                                        </div><!-- end media -->--%>
<%--                                    </div><!-- end col -->--%>
...
<%--                                    <div class="blog-meta big-meta col-md-8">--%>
<%--                                        <h4><a href="<c:url value="/detail?id=${stagingList.id}"/>" title="">${stagingList.title}</a></h4>--%>
<%--                                        <p>${stagingList.description}</p>--%>
<%--                                        <small class="firstsmall"><a class="bg-orange" href="tech-category-01.html" title="">${stagingList.nameCategory}</a></small>--%>
<%--                                        <small><a href="tech-single.html" title="">${stagingList.timeUp} </a></small>--%>
<%--                                        <small><a href="tech-author.html" title="">${stagingList.authorName}</a></small>--%>
<%--                                    </div><!-- end meta -->--%>
<%--                                </div><!-- end blog-box -->--%>
<%--                                <hr class="invis">--%>
<%--                            </c:forEach>--%>
